function init_life_time() {
	function getAsideLifeTime() {
		...
		$("#dayProgress .progress .progress-bar").css(
			"width",
			parseInt(todayPassHoursPercent) + "%"
		);
		$("#dayProgress .progress .progress-bar").html(
			parseInt(todayPassHoursPercent) + "%"
		);
		/* 当前周几 */
		let weeks = {
		...
		$("#weekProgress .progress .progress-bar").html(
			parseInt(weekDayPassPercent) + "%"
		);
		/* 月 */
		...
		$("#monthProgress .progress .progress-bar").html(
			parseInt(monthPassPercent) + "%"
		);
		/* 年 */
		...
		$("#yearProgress .progress .progress-bar").html(
			parseInt(yearPass) + "%"
		);
	}
	getAsideLifeTime();
